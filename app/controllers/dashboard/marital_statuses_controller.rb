class Dashboard::MaritalStatusesController < DashboardController
  ...
  def new
    @marital_status = Dashboard::MaritalStatus.new
  end
  ...
  def create
    @marital_status = Dashboard::MaritalStatus.new(marital_status_params)
  ...
  private
    ...
    def set_marital_status
      @marital_status = Dashboard::MaritalStatus.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def marital_status_params
      params.require(:dashboard_marital_status).permit(:description)
    end
end
